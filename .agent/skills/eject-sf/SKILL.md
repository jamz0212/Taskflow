...
- .agent/skills/ (skills del proyecto)
- .agent/design-systems/ (sistemas de diseno)
- .agent/skills/ai/references/ (AI templates)
- .agent/PRPs/ (templates PRP)
...
### Paso 4: Eliminar .agent/ (auto-destruccion)

Este es el ULTIMO paso porque este skill esta dentro de `.agent/`:
