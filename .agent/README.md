...
Este archivo documenta los assets fuente en `saas-factory/.agent/`.
...
- Source-of-truth unico: estos assets fuente viven en `.agent/` y se remapean
...
- Si se cambia un path hardcodeado a `.agent/`, convertirlo a variante runner-aware cuando aplique
...
- Source of truth de assets AI: `saas-factory/.agent/`
