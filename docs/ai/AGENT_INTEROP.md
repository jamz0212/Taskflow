...
Si el runner no soporta el sistema de skills o comandos `/sdd:*`, usar prompts directos referenciando el skill dentro del directorio AI del runner activo (`.claude/`, `.gemini/`, `.opencode/`, `.agent/`, `.cursor/`, o `.windsurf/`):
