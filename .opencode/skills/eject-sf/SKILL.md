...
- .opencode/design-systems/ (sistemas de diseno)
- .opencode/skills/ai/references/ (AI templates)
- .opencode/PRPs/ (templates PRP)
...
### Paso 4: Eliminar .opencode/ (auto-destruccion)

Este es el ULTIMO paso porque este skill esta dentro de `.opencode/`:
